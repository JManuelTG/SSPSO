...
class App():
    ...
    def __init__(self,master) -> None:
        ...
        id_proceso = Entry(frame_agregar, width=30)
        ...
        tiempo = Entry(frame_agregar, width=30)
        ...
        prioridad = Entry(frame_agregar, width=30)
        ...
        ttk.Button(frame_agregar, text="Agregar",bootstyle="success-outline", command=lambda: (self.planificadores.add_process(id_proceso.get(),int(tiempo.get()),int(prioridad.get())),
                                                           ...
                                                           prioridad.delete(0,"end"),self.actualizar_tabla())).grid(row=4,column=0,pady=5,padx=30)

        # Crear objeto Treeview
        self.table = ttk.Treeview(frame_table,yscrollcommand="none",show='headings',bootstyle="success",height=10)
